...
import com.vuatho.tests.uniform.catalog.UniformCatalogCrudTest;
...
import com.vuatho.tests.uniform.catalog.UniformCatalogSafeInteractionTest;
...
public final class UniformManagementSuiteRunner {
    ...
    public static void main(String[] args) {
        TestNgRunner.run(
                ...
                UniformCatalogSafeInteractionTest.class,
