...
/** Kiểm tra chuyên biệt nhóm VT Care trong Lịch sử giao dịch. */
public class TransactionInsuranceTest extends TransactionCategoryTestSupport {
    public static void main(String[] args) {
        TestNgRunner.run(TransactionInsuranceTest.class, "Lịch sử giao dịch", "VT Care");
    }
