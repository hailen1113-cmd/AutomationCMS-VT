...
public class DetailStateTest extends WorkerViolationTestSupport {
    public static void main(String[] args) {
        TestNgRunner.run(DetailStateTest.class,
                "Bo test chi tiet tho vi pham", "Kiem tra detail va page state");
    }

    @Test(groups = {"violation-worker", "detail"},
            description = WorkerViolationTestCases.WORKER_VIOLATION_001)
    ...
    @Test(groups = {"violation-worker", "detail"},
            description = WorkerViolationTestCases.WORKER_VIOLATION_002)
    ...
    @Test(groups = {"violation-worker", "state"},
            description = WorkerViolationTestCases.WORKER_VIOLATION_003)
    ...
    @Test(groups = {"violation-worker", "state"},
            description = WorkerViolationTestCases.WORKER_VIOLATION_004)
