package com.vuatho.tests.uniform.inventory.salesstock.receipts.list;
...
public class SalesReceiptPaginationTest extends SalesStockReceiptTestSupport {
    public static void main(String[] args) {
        TestNgRunner.run(SalesReceiptPaginationTest.class, "Kho bán hàng", "Phân trang tab Phiếu");
    }
