...
public class SalesReceiptOverviewTest extends SalesStockReceiptTestSupport {
    public static void main(String[] args) {
        TestNgRunner.run(SalesReceiptOverviewTest.class, "Kho bán hàng", "Tổng quan tab Phiếu");
    }
