 ...
 */
public class UniformCatalogSearchFilterCombinationTest extends UniformModuleTestSupport {
    ...
    public static void main(String[] args) {
        TestNgRunner.run(UniformCatalogSearchFilterCombinationTest.class,
