 ...
 */
public class DetailInteractionTest extends UserProfileTestSupport {
    ...
    public static void main(String[] args) {
        TestNgRunner.run(DetailInteractionTest.class,
    ...
    @Test(priority = 1,
            ...
            description = UserProfileTestCases.USER_PROFILE_002)
    ...
    @Test(priority = 2,
            ...
            description = UserProfileTestCases.USER_PROFILE_003)
