...
public class SearchTest extends BaseTest {
    ...
    public static void main(String[] args) {
        TestNgRunner.run(SearchTest.class,
    ...
    @Test(priority = 1, groups = { "user-profile", "user-search" },
            description = UserProfileTestCases.USER_PROFILE_005)
    ...
    @Test(priority = 2, groups = { "user-profile", "user-search" },
            description = UserProfileTestCases.USER_PROFILE_006)
    ...
    @Test(priority = 3, groups = { "user-profile", "user-search" },
            description = UserProfileTestCases.USER_PROFILE_007)
    ...
    @Test(priority = 4, groups = { "user-profile", "user-search" },
            description = UserProfileTestCases.USER_PROFILE_008)
