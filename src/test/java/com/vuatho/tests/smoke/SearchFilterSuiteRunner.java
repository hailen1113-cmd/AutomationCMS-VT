 ...
 */
public final class SearchFilterSuiteRunner {
    /** Không cho khởi tạo vì lớp này chỉ là điểm chạy suite. */
    private SearchFilterSuiteRunner() {
    }
    ...
    public static void main(String[] args) {
        TestNgRunner.run(
                ...
                com.vuatho.tests.userprofile.SearchTest.class,
                com.vuatho.tests.workerprofile.SearchTest.class,
                // Kiểm tra từng tiêu chí lọc của danh sách hồ sơ thợ.
                FilterTest.class,
                // Xác nhận reset đưa bộ lọc về trạng thái ban đầu trên nhiều menu.
                SearchFilterResetTest.class);
    }
}
