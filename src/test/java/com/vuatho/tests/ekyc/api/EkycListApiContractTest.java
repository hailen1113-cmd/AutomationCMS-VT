package com.vuatho.tests.ekyc.api;
...
public class EkycListApiContractTest extends EkycApiTestSupport {
     ...
     */
    @Test(description = EkycTestCases.EKYC_004, groups = {"ekyc", "api", "contract"})
     ...
     */
    @Test(description = EkycTestCases.EKYC_005, groups = {"ekyc", "api", "contract"})
     ...
     */
    @Test(description = EkycTestCases.EKYC_006, dataProvider = "listStatusFilters", groups = {"ekyc", "api", "contract"})
     ...
     * @param label giá trị label được truyền vào
     */
    @Test(description = EkycTestCases.EKYC_007, dataProvider = "listTypeFilters", groups = {"ekyc", "api", "contract"})
     ...
     */
    @Test(description = EkycTestCases.EKYC_009, groups = {"ekyc", "api", "contract"})
     ...
     */
    @Test(description = EkycTestCases.EKYC_010, groups = {"ekyc", "api", "contract"})
     ...
     * @param label giá trị label được truyền vào
     */
    @Test(description = EkycTestCases.EKYC_012, dataProvider = "invalidListQueries", groups = {"ekyc", "api", "contract"})
