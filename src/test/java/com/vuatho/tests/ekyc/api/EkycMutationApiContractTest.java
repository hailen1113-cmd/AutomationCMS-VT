...
public class EkycMutationApiContractTest extends EkycApiTestSupport {
     ...
     */
    @Test(description = EkycTestCases.EKYC_013, groups = {"ekyc", "api", "contract", "mutation"})
     ...
     */
    @Test(description = EkycTestCases.EKYC_014, groups = {"ekyc", "api", "contract", "mutation"})
     ...
     */
    @Test(description = EkycTestCases.EKYC_015, groups = {"ekyc", "api", "contract", "mutation"})
