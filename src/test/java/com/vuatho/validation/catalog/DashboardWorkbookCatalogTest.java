...
public class DashboardWorkbookCatalogTest {
     ...
     */
    @Test(description = "DASH-019 - The supplied dashboard workbook contains exactly 222 unique test cases")
    ...
    @Test(dependsOnMethods = "workbookContainsAllExpectedTestCases",
            description = "DASH-020 - The dashboard automation feasibility inventory is explicit and stable")
